...
public class JogoDAO {
        public static boolean inserir(Jogo jogo) {
            try {
                ...
                ps.setString(3, String.valueOf(jogo.getPreco()));
                ps.setInt(4, jogo.getNumroDias());
        ...
        public static boolean alterar (Jogo jogo) {
                ...
                String sql = "UPDATE jogo SET " 
                        + "titulo = ?, descricao = ?, preco = ?, numeroDias = ?, categoria_id = ?, memoria = ?, tipo = ?"
                        + "WHERE id = ?";
                PreparedStatement ps = conexao.prepareStatement(sql);
                ps.setString(1, jogo.getTitulo());
                ps.setString(2, jogo.getDescricao());
        ...
        public static List<Jogo> listar() {
             ...
             try {
                 ...
                 while(res.next()) {
                     ...
                     j.setNumroDias(res.getInt("numeroDias"));
